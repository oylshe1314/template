...
public class UserPasswordAuthFilter extends AbstractAuthenticationProcessingFilter {

    private final ObjectMapper objectMapper;

    public UserPasswordAuthFilter(String processesUrl, ObjectMapper objectMapper) {
        super(processesUrl);
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        try {
            ...
            if (!StringUtils.hasText(loginDto.getAccount()) || !StringUtils.hasText(loginDto.getPassword())) {
